      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6">
        ...
        {isOpen && (
          <div className="md:hidden absolute top-16 left-0 w-full bg-green-800 flex flex-col items-center py-4">
            ...
            <Link to="footer" smooth={true} duration={500} onClick={toggleMenu} className="px-3 py-2 text-white text-sm font-medium hover:bg-green-700 transition duration-300">Footer</Link>
          </div>
        )}
      </div>
    </nav>
